...
def baliho():
	try:
		...
		print '====='.center(44)
		print ' ' + W
		print ('DW SQUAD OFFICAL').center(44)
		print (W + '     [' + G +'DW FACEBOOK HACK INFORMATION'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     DW
    Name       DW SQUAD INFORMATION FACEBOOK 'Hacker'
    CodeName   Python
    version    full version
    Date       16/05/2018 09:35:12
    Team       DW Lentera Pelita Harapan White Hat
    Email      =====
    Telegram   @dwsquadori
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   get_data           Mendapatkan data teman
   get_info           Menunjukkan informasi teman

   dump_id            Hack id
   dump_phone         Hack nomer hp
   dump_mail          hack email
   dump_<id>_id       Rahasia
		      ex: dump_username_id

   token              Mendapatkan token
   cat_token          Menunjukan akses token
   rm_token           bakar akses token
...
def bot_ask():
	...
	try:
		token = open('cookie/token.log','r').read()
		print '[*] Berhasil silahkan login ulang'
	except IOError:
		print '[!] Gagal mendapatkan'
